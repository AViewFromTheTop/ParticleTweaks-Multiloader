...
public class TorchParticleUtil {
	...
	public static boolean onTorchTick(
		...
		ParticleOptions flareParticle = isSoulTorch ? ParticleTweaksParticleTypes.SOUL_FLARE.get() : ParticleTweaksParticleTypes.FLARE.get();
		...
		if (tickCount % 8 == 0) {
			world.addParticle(
				tickCount % 16 == 0 ?
					ParticleTweaksParticleTypes.COMFY_SMOKE_B.get() : ParticleTweaksParticleTypes.COMFY_SMOKE_A.get(),
				x,
				y,
				z,
				0.0D,
